...
for migration in 0001_core.sql 0002_org_encryption_keys.sql 0003_audit_append_only.sql 0004_auth.sql; do
...
echo "account, token, session, CSRF, and migration flows validated"
